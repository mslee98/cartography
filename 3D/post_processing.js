...
var scene, camera, renderer, mesh, group, target;
...
var local = document.location.href.indexOf( "barradeau" ) == -1;
if( local )
{
    ele_provider = proxy + "http://dem-grabber/elasticterrain/{z}/{x}/{y}.png";
} else {
    ele_provider =  proxy + "http://elasticterrain.xyz/data/tiles/{z}/{x}/{y}.png";
}
